...
miniLOL.Template.Engine.add("haml",Class.create({initialize:function(i){this.template=Haml.optimize(Haml.compile(i.content))},interpolate:function(i,o){return Haml.execute(this.template,o||window,i)}}));var Haml;
