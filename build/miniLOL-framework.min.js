...
Object.extend(String.prototype,function(){var a=window.encodeURI,b=window.decodeURI,c=window.encodeURIComponent,d=window.decodeURIComponent;return{toQueryParams:function(){var e={},f=this.match(/[?#](.*)$/);if(!f)return e;f=f[1].split(/&/);for(var g=0;g<f.length;g++){var h=f[g].split(/=/),i=h[0].decodeURIComponent();e[i]=h[1]?h[1].decodeURIComponent():true}return e},toXML:function(){return(new DOMParser).parseFromString(this,"text/xml")},isURL:function(){return/^(\w+):(\/\/.+?(:\d)?)(\/)?/.test(this)||
/^mailto:([\w.%+-]+@[\w.]+\.[A-Za-z]{2,4})$/.test(this)},parseURL:function(){var e=this.match(/^mailto:(([\w.%+-]+)@([\w.]+\.[A-Za-z]{2,4}))$/);if(e)return{protocol:"mailto",uri:e[1],user:e[2],host:e[3]};e=this.match(/^((\w+):\/\/(((.+?)(:(\d+)?))(\/?.*)))$/);if(!e)return false;return{full:e[1],protocol:e[2],uri:e[3],host:e[4],hostname:e[5],port:e[7],path:e[8]}},blank:function(){return this==0},getHashFragment:function(){var e=this.match(/(#.*)$/);return e?e[1]:""},encodeURI:function(){return a(this)},
decodeURI:function(){return b(this)},encodeURIComponent:function(){return c(this)},decodeURIComponent:function(){return d(this)}}}());
...
c.open();c.close();c.location.hash=encodeURIComponent(b.substring(1))},get:function(){miniLOL.History.IE.check();return miniLOL.History.IE.element.contentWindow.document.location.hash},element:new Element("iframe",{id:"__miniLOL.History",style:"display: none !important; z-index: -9001 !important;",src:"javascript:false;"})};var a=miniLOL.History.current;$(document.body).insert({top:miniLOL.History.IE.element});miniLOL.History.IE.put(a);miniLOL.History.reset(miniLOL.History.interval,miniLOL.History.Checkers.InternetExplorer)})}},
