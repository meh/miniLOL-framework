...
Object.extend(Object,function(){var b,a;if(function(){for(var d in{toString:1})if(d==="toString")return false;return true}()){var c=Object.keys,f=Object.values,h=["toString","valueOf"];b=function(d){var i=c(d);h.each(function(k){d[k]!=Object.prototype[k]&&i.push(k)});return i};a=function(d){var i=f(d);h.each(function(k){d[k]!=Object.prototype[k]&&i.push(d[k])});return i}}else{b=Object.keys;a=Object.values}var e=Object.isFunction(Object.defineProperty)?Object.defineProperty:function(d,i,k){Object.isFunction(k.get)&&
Object.isFunction(d.__defineGetter__)&&d.__defineGetter__(i,k.get);Object.isFunction(k.set)&&Object.isFunction(d.__defineSetter__)&&d.__defineSetter__(i,k.set)};if(Object.isFunction(Object.defineProperties))var g=Object.defineProperties;else Object.defineProperties=function(d,i){for(var k in i)Object.defineProperty(d,k,i[k])};if(Object.isFunction(Object.create))var j=Object.create;else Object.create=function(d,i){var k=Object(d);Object.defineProperties(k,i);return k};return{isObject:function(d){return typeof d==
...
d[l]=function(n,o){return Object.isUndefined(n)&&!o?Object.isFunction(i[l].get)?i[l].get(m):m:Object.isFunction(i[l].set)?m=i[l].set(m,n):m=n}})();return d},without:function(d,i){var k=Object.extend({},d);if(Object.isArray(i))i.each(function(l){delete k[l]});else delete k[i];return k},defineProperty:e,defineProperties:g,create:j}}());
...
Object.extend(String.prototype,function(){function b(e){Object.isRegExp(e)||(e=/&/);var g={},j=this.match(/[?#](.*?)([#?]|$)/);if(!j)return g;e=j[1].split(e);for(j=0;j<e.length;j++){var d=e[j].split(/=/),i=d[0].decodeURIComponent();if(d=d[1])if(Object.isUndefined(g[i]))g[i]=d.decodeURIComponent();else if(Object.isArray(g[i]))g[i].push(d);else g[i]=[g[i],d];else g[i]=true}return g}var a=window.encodeURI,c=window.decodeURI,f=window.encodeURIComponent,h=window.decodeURIComponent;return{toQueryParams:b,
...
blank:function(){return this==0},getHashFragment:function(){var e=this.match(/(#.*)$/);return e?e[1]:""},splitEvery:function(e){for(var g=[],j=0;j<this.length;j+=e)g.push(this.substr(j,e));return g},test:function(e){return e.test(this)},commonChars:function(e){return this.toArray().intersect(e.toArray())},format:function(e){var g=this;for(var j in e)g=g.replace(RegExp("\\{"+j+"\\}","g"),e[j].toString());return g},reverse:function(){return this.toArray().reverse().join("")},translate:function(e,g){var j=
this;g?Object.keys(e).each(function(d){if(!g[d])throw Error("The second table value is missing.");j=e[d].is(RegExp)?j.replace(eval(e[d].global?e[d].toString():e[d].toString()+"g")):j.replace(RegExp(e[d],"g"),g[d])}):Object.values(e).each(function(d){if(d.length!=2)throw Error("The array has to be [regex, translation].");j=d[0].is(RegExp)?j.replace(eval(d[0].global?d[0].toString():d[0].toString()+"g"),d[1]):j.replace(RegExp(d[0],"g"),d[1])});return j},toNumber:function(e){return e?parseInt(this):parseFloat(this)},
toBase:function(e){return this.toNumber().toBase(e)},fromBase:function(e){return parseInt(this,e)},toCode:function(){return this.charCodeAt(0)},toPaddedString:function(e,g,j){g=Object.isUndefined(j||g)?"0":(j||g).toString();return g.times(e-this.length)+this},toInvertedCase:function(){for(var e="",g=0,j=this.length;g<j;g++){var d=this.charAt(g),i=d.toLowerCase(),k=d.toUpperCase();e+=k==i?i:d==i?k:i}return e},encodeURI:function(){return a(this)},decodeURI:function(){return c(this)},encodeURIComponent:function(){return f(this)},
decodeURIComponent:function(){return h(this)}}}());
Object.extend(Number.prototype,function(){function b(){return this*1E3}function a(){return this}function c(){return this*60}function f(){return this*60*60}function h(){return this*60*60*24}function e(){return this*60*60*24*7}function g(){return this*60*60*24*375}return{milliseconds:b,ms:b,seconds:a,second:a,minutes:c,minute:c,hours:f,hour:f,days:h,day:h,weeks:e,week:e,years:g,year:g,upTo:function(j,d,i){$R(this,j+1,true).each(d,i);return this},isEven:function(){return this%2==0},isOdd:function(){return this%
...
(function(){Date.weekDays=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"];Date.months=["January","February","March","April","May","June","July","August","September","October","November","December"];var b={flag:{"-":function(a){return a},_:function(a,c){return a.toPaddedString(c,10," ")},"0":function(a,c){return a.toPaddedString(c,10,"0")},"^":function(a,c){return a.toString().toUpperCase().toPaddedString(c," ")},"#":function(a,c){return a.toString().toInvertedCase().toPaddedString(c,
" ")}},width:{d:2,H:2,I:2,j:3,k:2,l:2,m:2,M:2,N:9,S:2,U:2,V:2,W:2,y:2,i:3},"%":function(){return"%"},a:function(a){return Date.weekDays[a.getDay()].substr(0,3)},A:function(a){return Date.weekDays[a.getDay()]},b:function(a){return Date.months[a.getMonth()].substr(0,3)},B:function(a){return Date.months[a.getMonth()]},c:function(a){return a.format("%a %b %_d %X %Y")},C:function(a){return a.getFullYear().toString().substr(0,2)},d:function(a){return a.getDate()},D:function(a){return a.format("%m/%d/%y")},
e:function(a){return a.format("%_d")},F:function(a){return a.format("%Y-%m-%d")},g:function(a){return a.format("%y")},G:function(a){return a.format("%Y")},h:function(a){return a.format("%b")},H:function(a){return a.getHours()},I:function(a){a=a.getHours();return a+1>12?(a+1)/2:a+1},j:function(a){var c=new Date;c.setFullYear(a.getFullYear());c.setDate(1);c.setMonth(0);return((a.getTime()-c.getTime())/1E3/60/60/24).ceil()},k:function(a){return a.format("%_H")},l:function(a){return a.format("%_l")},
m:function(a){return a.getMonth()+1},M:function(a){return a.getMinutes()},n:function(){return"\n"},N:function(a){return a.getMilliseconds()*1E6},p:function(a){return a.getHours()>12?"PM":"AM"},P:function(a){return a.format("%#p")},r:function(a){return a.format("%I:%M:%S %p")},R:function(a){return a.format("%H:%M")},s:function(a){return a.getDate()},S:function(a){return a.getSeconds()},t:function(){return"\t"},T:function(a){return a.format("%H:%M:%S")},u:function(a){return a.getDay()==0?7:a.getDay()},
U:function(a){var c=new Date;c.setFullYear(a.getFullYear());c.setDate(1);c.setMonth(0);return((a.getTime()-c.getTime())/1E3/60/60/24/7).ceil()},V:function(a){return a.format("%U")},w:function(a){return a.getDay()},W:function(a){return a.format("%U")},x:function(a){return a.format("%m/%d/%y")},X:function(a){return a.format("%T")},y:function(a){return a.getFullYear().toString().substr(2,2)},Y:function(a){return a.getFullYear()},E:function(a){if(a.getMonth()%2==0)return 31;if(a.getMonth()==1)return a.getFullYear()%
4==0?29:28;return 30},o:function(a){return a.getDate().ordinalized()},O:function(a){return a.getFullYear()%4?0:1},i:function(a){var c=new Date(a);c.setHours(0);c.setSeconds(0);c.setMinutes(0);return((a.getTime()-c.getTime())/1E3/86.4).toFixed(2)}};Object.extend(Date,function(){var a=Date.parse;return{parse:function(c){if(!c.include("%"))return a(c)}}}());Object.extend(Date.prototype,function(){return{format:function(a){var c=this;return a.gsub(/%([\-_0^#])?(\d+)?(.)/,function(f){var h=f[1]||"0",e=
parseInt(f[2]||b.width[g]||"0"),g=f[3];if(!b[g])return f[0];return b.flag[h](b[g](c),e)})}}}())})();
window.Element.addMethods(function(){return{load:function(b,a){if(a&&!Object.isUndefined(a.frequency))new Ajax.PeriodicalUpdater(this,b,a);else new Ajax.Updater(this,b,a)},xpath:Prototype.Browser.IE?function(b,a){if(Object.isUndefined(a)){a=b;b=this}for(var c=[],f=b.selectNodes(a),h=0;h<f.length;h++)c.push(f.item(h));return c}:function(b,a){if(Object.isUndefined(a)){a=b;b=this}for(var c=[],f=(b.ownerDocument||b).evaluate(a,b,null,XPathResult.ORDERED_NODE_SNAPSHOT_TYPE,null),h=0;h<f.snapshotLength;h++)c.push(f.snapshotItem(h));
...
c.nodeValue.strip();throw $break;}break}});return a},toObject:function(b){b=b||this;var a={};if(!Object.isElement(b)&&!Object.isDocument(b))return a;$A(b.childNodes).each(function(c){if(c.nodeType==Node.ELEMENT_NODE)if(c.getElementsByTagName("*").length==0){var f="";$A(c.childNodes).each(function(h){h.nodeType!=Node.CDATA_SECTION_NODE&&h.nodeType!=Node.TEXT_NODE||h.nodeValue.blank()||(f+=h.nodeValue)});a[c.nodeName]=f}else a[c.nodeName]=Element.toObject(c)});return a}}}());
if(!Object.isObject(window.miniLOL))window.miniLOL={error:Function.empty,Framework:{Version:"0.1"}};
Class=function(){var b={Normal:1,Abstract:2},a=function(){return{addMethods:function(c){for(var f=this.superclass&&this.superclass.prototype,h=Object.keys(c),e=0,g=h.length;e<g;e++){var j=h[e],d=c[j];if(f&&Object.isFunction(d)&&d.argumentNames().first()=="$super"){var i=d;d=function(k){return function(){return f[k].apply(this,arguments)}}(j).wrap(i);d.valueOf=i.valueOf.bind(i);d.toString=i.toString.bind(i)}this.prototype[j]=d;if(this.__type__==Class.Abstract)this[j]=d}},addStatic:function(c){for(var f=
Object.keys(c),h=0,e=f.length;h<e;h++){var g=f[h];this[g]=c[g]}},addAttributes:function(c){Object.extendAttributes(this.prototype,c);this.__type__==Class.Abstract&&Object.extendAttributes(this,c)}}}();return{create:function(){var c=$A(arguments),f=Object.isFunction(c.first())?c.shift():null,h=function(){switch(this.__type__){case b.Abstract:throw Error("You cannot instantiate an abstract class.");default:if(Object.isFunction(this.initialize))return this.initialize.apply(this,arguments);break}return null};
h["__miniLOL.Class__"]=true;Object.extend(h,Class.Methods);h.superclass=f;h.subclasses=[];if(f){if(!f.__type__)f.__type__=b.Normal;if(!f.subclasses)f.subclasses=[];var e=Function.empty.clone();e.prototype=f.prototype;h.prototype=new e;f.subclasses.push(h)}h.__type__=h.prototype.__type__=c.first().type||Class.Normal;c.each(function(g){h.addMethods({initialize:g.initialize||g.constructor||Function.empty.clone()});h.addMethods(Object.without(g,["constructor","initialize","Methods","Static","Attributes"]));
h.addMethods(g.Methods||{});h.addStatic(g.Static||{});h.addAttributes(g.Attributes||{})});return h.prototype.constructor=h},Type:b,Methods:a}}();
miniLOL.utils=function(){return{exists:function(b){var a=false;new Ajax.Request(b,{method:"head",asynchronous:false,onSuccess:function(){a=true}});return a},get:function(b,a){var c;new Ajax.Request(b,{method:"get",minified:a,asynchronous:false,onSuccess:function(f){c=f.responseText}});return c},execute:function(b){var a,c;new Ajax.Request(b,{method:"get",asynchronous:false,evalJS:false,onSuccess:function(f){try{a=window.eval(f.responseText)}catch(h){c=h;c.fileName=b;c.lineNumber-=5}},onFailure:function(f){c=
...
this.flush().each(function(b){this.load.apply(this,b)},this);Event.fire(document,":resource.reloaded",{resource:this})},clear:function(){Event.fire(document,":resource.clear",{resource:this});this.wrapper.clear()},flush:function(b){Event.fire(document,":resource.flush",{resource:this,call:b});var a;if(Object.isArray(b)){if(a=this.calls.find(function(c){if(c.length!=b.length)return false;for(var f=false,h=0;h<c.length;h++){if(b[h]==c[h])f=true;if(!f)break}return f}))this.calls=this.calls.filter(function(c){return c!=
...
miniLOL.Cookie=function(){function b(h){return Object.extend({expires:new Date(Date.now()+(1).day().ms()),path:"",domain:"",secure:"",raw:false},h||{})}function a(h,e,g){if(Object.isUndefined(g))g={};return"#{key}=#{value}; #{maxAge}#{expires}#{path}#{domain}#{secure}".interpolate({key:h.encodeURIComponent(),value:e.encodeURIComponent(),maxAge:!Object.isUndefined(g.maxAge)?"max-age=#{0}; ".interpolate([g.maxAge]):"",expires:!Object.isUndefined(g.expires)?"expires=#{0}; ".interpolate([g.expires.toUTCString()]):
"",path:!Object.isUndefined(g.path)?"path=#{0}; ".interpolate([g.path]):"",domain:!Object.isUndefined(g.domain)?"domain=#{0}; ".interpolate([g.domain]):"",secure:g.secure?"secure":""})}function c(){var h=[];window.document.cookie.split(/; /).each(function(e){e=e.split(/=/);h.push(e[0])});return h.uniq()}function f(h,e){window.document.cookie=a(h,"",Object.extend(b(e),{expires:new Date(0)}))}return{encode:a,keys:c,get:function(h,e){e=b(e);var g=window.document.cookie.match(RegExp.escape(h.encodeURIComponent())+
"=([^;]*)","g");if(g){var j=[];$A(g).each(function(d){d=d.match(/^.*?=(.*)$/)[1].decodeURIComponent();j.push(e.raw?d:miniLOL.JSON.unserialize(d)||d)});if(j.length==1)j=j[0];return j}},set:function(h,e,g){g=b(g);g.raw||(e=miniLOL.JSON.serialize(e)||e);window.document.cookie=a(h,e,g)},remove:f,clear:function(){c().each(function(h){f(h)})}}}();
