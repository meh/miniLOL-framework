...
toBase:function(h){return this.toString(h).toUpperCase()},toChar:function(){return String.fromCharCode(this)},digits:function(){var h=this.toString().match(/e(.*)$/);return h?h[1].toNumber()>0?1+h[1].toNumber():0:this.toString().length},ordinalize:function(){switch(parseInt(this)){case 1:return"st";case 2:return"nd";case 3:return"rd";default:return"th"}}}}());
(function(){Date.weekDays=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"];Date.months=["January","February","March","April","May","June","July","August","September","October","November","December"];Object.extend(Date,function(){var a=Date.parse;return{parse:function(b){if(!b.include("%"))return a(b)}}}());Object.extend(Date.prototype,function(){return{format:function(){}}}())})();
