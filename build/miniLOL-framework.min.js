...
Object.isFunction(e.__defineGetter__)&&e.__defineGetter__(i,k.get);Object.isFunction(k.set)&&Object.isFunction(e.__defineSetter__)&&e.__defineSetter__(i,k.set)};if(Object.isFunction(Object.defineProperties))var h=Object.defineProperties;else Object.defineProperties=function(e,i){for(var k in i)Object.defineProperty(e,k,i[k])};if(Object.isFunction(Object.create))var g=Object.create;else Object.create=function(e,i){var k=Object(e);Object.defineProperties(k,i);return k};return{is:function(e,i){return i&&
...
Object.extend(String.prototype,function(){function b(f){Object.isRegExp(f)||(f=/&/);var h={},g=this.match(/[?#](.*?)([#?]|$)/);if(!g)return h;f=g[1].split(f);for(g=0;g<f.length;g++){var e=f[g].split(/=/),i=e[0].decodeURIComponent();if(e=e[1])if(Object.isUndefined(h[i]))h[i]=e.decodeURIComponent();else if(Object.isArray(h[i]))h[i].push(e);else h[i]=[h[i],e];else h[i]=true}return h}var c=window.encodeURI,a=window.decodeURI,d=window.encodeURIComponent,j=window.decodeURIComponent;return{toQueryParams:b,
...
toBase:function(f){return this.toNumber().toBase(f)},fromBase:function(f){return parseInt(this,f)},toCode:function(){return this.charCodeAt(0)},toPaddedString:function(f,h,g){h=Object.isUndefined(g||h)?"0":(g||h).toString();return h.times(f-this.length)+this},toInvertedCase:function(){for(var f="",h=0,g=this.length;h<g;h++){var e=this.charAt(h),i=e.toLowerCase(),k=e.toUpperCase();f+=k==i?i:e==i?k:i}return f},encodeURI:function(){return c(this)},decodeURI:function(){return a(this)},encodeURIComponent:function(){return d(this)},
decodeURIComponent:function(){return j(this)}}}());
Object.extend(Number.prototype,function(){function b(){return this*1E3}function c(){return this}function a(){return this*60}function d(){return this*60*60}function j(){return this*60*60*24}function f(){return this*60*60*24*7}function h(){return this*60*60*24*375}return{milliseconds:b,ms:b,seconds:c,second:c,minutes:a,minute:a,hours:d,hour:d,days:j,day:j,weeks:f,week:f,years:h,year:h,upTo:function(g,e,i){$R(this,g+1,true).each(e,i);return this},isEven:function(){return this%2==0},isOdd:function(){return this%
...
toPaddedString:function(g,e,i){i=Object.isUndefined(i)?"0":i.toString();e=this.toString(e||10);return i.times(g-e.length)+e},toBase:function(g){return this.toString(g).toUpperCase()},toChar:function(){return String.fromCharCode(this)},digits:function(){var g=this.toString().match(/e(.*)$/);return g?g[1].toNumber()>0?1+g[1].toNumber():0:this.toString().length},ordinalized:function(){switch(parseInt(this)){case 1:return"st";case 2:return"nd";case 3:return"rd";default:return"th"}}}}());
...
Class=function(){var b={Normal:1,Abstract:2},c=function(){return{addMethods:function(a){for(var d=this.superclass&&this.superclass.prototype,j=Object.keys(a),f=0,h=j.length;f<h;f++){var g=j[f],e=a[g];if(d&&Object.isFunction(e)&&e.argumentNames().first()=="$super"){var i=e;e=function(k){return function(){return d[k].apply(this,arguments)}}(g).wrap(i);e.valueOf=i.valueOf.bind(i);e.toString=i.toString.bind(i)}this.prototype[g]=e;if(this.__type__==Class.Abstract)this[g]=e}},addStatic:function(a){for(var d=
Object.keys(a),j=0,f=d.length;j<f;j++){var h=d[j];this[h]=a[h]}},addAttributes:function(a){Object.extendAttributes(this.prototype,a);this.__type__==Class.Abstract&&Object.extendAttributes(this,a)}}}();return{create:function(){var a=$A(arguments),d=Object.isFunction(a.first())?a.shift():null,j=function(){switch(this.__type__){case b.Abstract:throw Error("You cannot instantiate an abstract class.");default:if(Object.isFunction(this.initialize))return this.initialize.apply(this,arguments);break}return null};
...
miniLOL.utils=function(){return{exists:function(b){var c=false;new Ajax.Request(b,{method:"head",asynchronous:false,onSuccess:function(){c=true}});return c},get:function(b,c){var a;new Ajax.Request(b,Object.extend(c||{},{method:"get",asynchronous:false,onSuccess:function(d){a=d.responseText}}));return a},execute:function(b,c){var a,d;new Ajax.Request(b,Object.extend(c||{},{method:"get",asynchronous:false,evalJS:false,onSuccess:function(j){try{a=window.eval(j.responseText)}catch(f){d=f;d.fileName=
b;d.lineNumber-=5}},onFailure:function(j){d=Error("Failed to retrieve `#{file}` (#{status} - #{statusText}).".interpolate({file:b,status:j.status,statusText:j.statusText}));d.fileName=b;d.lineNumber=0}}));if(d)throw d;return a},include:function(b,c){var a=false;new Ajax.Request(b,Object.extend(c||{},{method:"get",asynchronous:false,evalJS:false,onSuccess:function(d){try{window.eval(d.responseText);a=true}catch(j){a=false}}}));return a},require:function(b,c){var a=false;new Ajax.Request(b,Object.extend(c||
{},{method:"get",asynchronous:false,evalJS:false,onSuccess:function(d){try{window.eval(d.responseText)}catch(j){a=j;a.fileName=b;a.lineNumber-=5}},onFailure:function(d){a=Error("Failed to retrieve `#{file}` (#{status} - #{statusText}).".interpolate({file:b,status:d.status,statusText:d.statusText}));a.fileName=b;a.lineNumber=0;a.http={status:d.status,text:d.statusText}}}));if(a)throw a;return true}}}();
...
"",path:!Object.isUndefined(g.path)?"path=#{0}; ".interpolate([g.path]):"",domain:!Object.isUndefined(g.domain)?"domain=#{0}; ".interpolate([g.domain]):"",secure:g.secure?"secure":""})}function a(){var f=[];window.document.cookie.split(/; /).each(function(h){h=h.split(/=/);f.push(h[0])});return f.uniq()}function d(f,h){h=b(h);var g=window.document.cookie.match(RegExp.escape(f.encodeURIComponent())+"=([^;]*)","g");if(g){var e=[];$A(g).each(function(i){i=i.match(/^.*?=(.*)$/)[1].decodeURIComponent();
e.push(h.raw?i:miniLOL.JSON.unserialize(i)||i)});if(e.length==1)e=e[0];return e}}function j(f,h){window.document.cookie=c(f,"",Object.extend(b(h),{expires:new Date(0)}))}return Object.extend(Enumerable,{_each:function(f){a().each(function(h){var g=d(h),e=[h,g];e.name=h;e.key=h;e.value=g;f(e)})},encode:c,keys:a,get:d,set:function(f,h,g){g=b(g);g.raw||(h=miniLOL.JSON.serialize(h)||h);window.document.cookie=c(f,h,g)},remove:j,unset:j,clear:function(){a().each(function(f){j(f)})}})}();
