...
Object.extend(Object,{isBoolean:function(a){return typeof a=="boolean"||a.constructor===Boolean},isObject:function(a){return typeof a=="object"},isDocument:function(a){return a.toString().include("Document")},isXML:function(a){if(typeof a!=="object")return false;a=a.ownerDocument||a;if(!a.documentElement)return false;return a.documentElement.nodeName!="HTML"},fromAttributes:function(a){for(var b={},c=0;c<a.length;c++)b[a.item(c).nodeName]=a.item(c).nodeName;return b},toQueryString:function(a){var b=
"";for(var c in a)b+="#{name}=#{value}&".interpolate({name:c,value:a[c]});return b.substr(0,b.length-1)}});if(!Object.isFunction(Object.defineProperty))Object.defineProperty=function(a,b,c){Object.isFunction(c.get)&&Object.isFunction(a.__defineGetter__)&&a.__defineGetter__(b,c.get);Object.isFunction(c.set)&&Object.isFunction(a.__defineSetter__)&&a.__defineSetter__(b,c.set)};
if(!Object.isFunction(Object.defineProperties))Object.defineProperties=function(a,b){for(var c in b)Object.defineProperty(a,c,b[c])};if(!Object.isFunction(Object.create))Object.create=function(a,b){var c=Object(a);Object.defineProperties(c,b);return c};Object.extend(String,{fromAttributes:function(a){for(var b="",c=0;c<a.length;c++)b+='#{name}="#{value}" '.interpolate({name:a.item(c).nodeName,value:a.item(c).nodeValue});return b},fromXML:function(a){if(!Object.isXML(a))return false;return(new XMLSerializer).serializeToString(a)}});
Object.extend(String.prototype,{toQueryParams:function(){var a={},b=this.match(/[?#](.*)$/);if(!b)return a;b=b[1].split(/&/);for(var c=0;c<b.length;c++){var d=b[c].split(/=/),e=d[0].decodeURIComponent();a[e]=d[1]?d[1].decodeURIComponent():true}return a},toXML:function(){return(new DOMParser).parseFromString(this,"text/xml")},isURL:function(){var a=this.match(/^mailto:([\w.%+-]+@[\w.]+\.[A-Za-z]{2,4})$/);if(a)return{protocol:"mailto",uri:a[1]};a=this.match(/^(\w+):(\/\/.+?(:\d)?)(\/)?/);if(!a)return false;
return{protocol:a[1],uri:a[2]}},blank:function(){return this==0},getHashFragment:function(){var a=this.match(/(#.*)$/);return a?a[1]:""},encodeURI:function(){return encodeURI(this)},decodeURI:function(){return decodeURI(this)},encodeURIComponent:function(){return encodeURIComponent(this)},decodeURIComponent:function(){return decodeURIComponent(this)}});
Element.addMethods({load:function(a,b){if(b&&!Object.isUndefined(b.frequency))new Ajax.PeriodicalUpdater(this,a,b);else new Ajax.Updater(this,a,b)},xpath:function(a,b){if(Object.isUndefined(b)){b=a;a=this}var c=[],d;if(Prototype.Browser.IE){d=a.real.selectNodes(b);for(var e=0;e<d.length;e++)c.push(d.item(e))}else{d=(a.ownerDocument||a).evaluate(b,a,null,XPathResult.ORDERED_NODE_SNAPSHOT_TYPE,null);for(e=0;e<d.snapshotLength;e++)c.push(d.snapshotItem(e))}return c},select:function(a,b){if(Object.isUndefined(b)){b=
a;a=this}return Prototype.Selector.select(b,a)},getTextDescendants:function(a){function b(d){for(d=d.firstChild;d;){Node.TEXT_NODE==d.nodeType&&c.push(d);Object.isElement(d)&&b(d);d=d.nextSibling}}a=a||this;var c=[];b(a);return c},getFirstText:function(a){a=a||this;var b="";if(Object.isElement(a))a=$A(a.childNodes);else Object.isArray(a)||(a=$A(a));a.each(function(c){switch(c.nodeType){case Node.ELEMENT_NODE:throw $break;case Node.CDATA_SECTION_NODE:case Node.TEXT_NODE:if(!c.nodeValue.blank()){b=
...
if(!Object.isObject(window.Document))window.Document={};
Object.extend(Document,{fix:function(a){if(a){if(Prototype.Browser.IE){a={real:a};a.documentElement=a.real.documentElement;a.getElementsByTagName=function(b){return this.real.getElementsByTagName(b)};a.getElementById=function(b){return miniLOL.utils.XML.getElementById.call(this.real,b)};a.real.setProperty("SelectionLanguage","XPath")}else if(!Prototype.Browser.Good)a.getElementById=function(b){return this.xpath("//*[@id='#{0}']".interpolate([b])).first()};a.xpath=Element.xpath;a.select=Element.select;
return a}},check:function(a,b){var c=false;a||(c="There is a syntax error.");if(a.documentElement.nodeName=="parsererror")c=a.documentElement.textContent;if(b&&c){miniLOL.error("Error while parsing #{path}\n\n#{error}".interpolate({path:b,error:c}),true);return c}return c}});if(!Object.isObject(window.miniLOL))window.miniLOL={error:Prototype.emptyFunction};
miniLOL.utils={exists:function(a){var b=false;new Ajax.Request(a,{method:"head",asynchronous:false,onSuccess:function(){b=true}});return b},includeCSS:function(a){var b;if(b=miniLOL.theme.style.list[a])return b;else if(b=$$("link").find(function(c){return c.getAttribute("href")==a}))return miniLOL.theme.style.list[a]=b;else if(b=miniLOL.utils.exists(a)){b=new Element("link",{rel:"stylesheet",href:a,type:"text/css"});$$("head")[0].insert(b);Event.fire(document,":css.included",b);return b}else return false},
css:function(a,b){var c=(new Element("style",{type:"text/css"})).update(a);b&&c.setAttribute("id",b);$$("head").first().appendChild(c);Event.fire(document,":css.created",c);return c},execute:function(a){var b,c;new Ajax.Request(a,{method:"get",asynchronous:false,evalJS:false,onSuccess:function(d){try{b=window.eval(d.responseText)}catch(e){c=e;c.fileName=a;c.lineNumber-=5}},onFailure:function(d){c=Error("Failed to retrieve `#{file}` (#{status} - #{statusText}).".interpolate({file:a,status:d.status,
statusText:d.statusText}));c.fileName=a;c.lineNumber=0}});if(c)throw c;return b},include:function(a){var b=false;new Ajax.Request(a,{method:"get",asynchronous:false,evalJS:false,onSuccess:function(c){try{window.eval(c.responseText);b=true}catch(d){b=false}}});return b},require:function(a){var b=false;new Ajax.Request(a,{method:"get",asynchronous:false,evalJS:false,onSuccess:function(c){try{window.eval(c.responseText)}catch(d){b=d;b.fileName=a;b.lineNumber-=5}},onFailure:function(c){b=Error("Failed to retrieve `#{file}` (#{status} - #{statusText}).".interpolate({file:a,
