...
Object.isFunction(e.__defineGetter__)&&e.__defineGetter__(j,k.get);Object.isFunction(k.set)&&Object.isFunction(e.__defineSetter__)&&e.__defineSetter__(j,k.set)};if(Object.isFunction(Object.defineProperties))var h=Object.defineProperties;else Object.defineProperties=function(e,j){for(var k in j)Object.defineProperty(e,k,j[k])};if(Object.isFunction(Object.create))var g=Object.create;else Object.create=function(e,j){var k=Object(e);Object.defineProperties(k,j);return k};return{isObject:function(e){return typeof e==
"object"&&e.constructor===Object},isBoolean:function(e){return typeof e=="boolean"||e.constructor===Boolean},isRegExp:function(e){return!Object.isUndefined(e)&&e.constructor==window.RegExp},isClass:function(e){return Boolean(e["__miniLOL.Class__"])},isDocument:function(e){return e.toString().include("Document")},isXML:function(e){if(typeof e!=="object")return false;e=e.ownerDocument||e;if(!e.documentElement)return false;return e.documentElement.nodeName!="HTML"},fromAttributes:function(e){for(var j=
{},k=0;k<e.length;k++)j[e.item(k).nodeName]=e.item(k).nodeName;return j},toQueryString:function(e){var j="";for(var k in e)j+="#{name}=#{value}&".interpolate({name:k,value:e[k]});return j.substr(0,j.length-1)},keys:b,values:c,extend:function(e,j,k){k=Object.isUndefined(k)?true:Boolean(k);for(var l=Object.keys(j),m=0,n=l.length;m<n;m++){var o=l[m];if(k||Object.isUndefined(destionation[o]))e[o]=j[o]}return e},extendAttributes:function(e,j,k){k=Object.isUndefined(k)?true:Boolean(k);for(var l in j)if(k||
Object.isUndefined(destionation[l]))(function(){var m;e[l]=function(n,o){return Object.isUndefined(n)&&!o?Object.isFunction(j[l].get)?j[l].get(m):m:Object.isFunction(j[l].set)?m=j[l].set(m,n):m=n}})();return e},without:function(e,j){var k=Object.extend({},e);if(Object.isArray(j))j.each(function(l){delete k[l]});else delete k[j];return k},defineProperty:f,defineProperties:h,create:g}}());
...
Object.extend(String.prototype,function(){function b(f){Object.isRegExp(f)||(f=/&/);var h={},g=this.match(/[?#](.*?)([#?]|$)/);if(!g)return h;f=g[1].split(f);for(g=0;g<f.length;g++){var e=f[g].split(/=/),j=e[0].decodeURIComponent();if(e=e[1])if(Object.isUndefined(h[j]))h[j]=e.decodeURIComponent();else if(Object.isArray(h[j]))h[j].push(e);else h[j]=[h[j],e];else h[j]=true}return h}var c=window.encodeURI,a=window.decodeURI,d=window.encodeURIComponent,i=window.decodeURIComponent;return{toQueryParams:b,
...
this;h?Object.keys(f).each(function(e){if(!h[e])throw Error("The second table value is missing.");g=f[e].is(RegExp)?g.replace(eval(f[e].global?f[e].toString():f[e].toString()+"g")):g.replace(RegExp(f[e],"g"),h[e])}):Object.values(f).each(function(e){if(e.length!=2)throw Error("The array has to be [regex, translation].");g=e[0].is(RegExp)?g.replace(eval(e[0].global?e[0].toString():e[0].toString()+"g"),e[1]):g.replace(RegExp(e[0],"g"),e[1])});return g},toNumber:function(f){return f?parseInt(this):parseFloat(this)},
toBase:function(f){return this.toNumber().toBase(f)},fromBase:function(f){return parseInt(this,f)},toCode:function(){return this.charCodeAt(0)},toPaddedString:function(f,h,g){h=Object.isUndefined(g||h)?"0":(g||h).toString();return h.times(f-this.length)+this},toInvertedCase:function(){for(var f="",h=0,g=this.length;h<g;h++){var e=this.charAt(h),j=e.toLowerCase(),k=e.toUpperCase();f+=k==j?j:e==j?k:j}return f},encodeURI:function(){return c(this)},decodeURI:function(){return a(this)},encodeURIComponent:function(){return d(this)},
decodeURIComponent:function(){return i(this)}}}());
Object.extend(Number.prototype,function(){function b(){return this*1E3}function c(){return this}function a(){return this*60}function d(){return this*60*60}function i(){return this*60*60*24}function f(){return this*60*60*24*7}function h(){return this*60*60*24*375}return{milliseconds:b,ms:b,seconds:c,second:c,minutes:a,minute:a,hours:d,hour:d,days:i,day:i,weeks:f,week:f,years:h,year:h,upTo:function(g,e,j){$R(this,g+1,true).each(e,j);return this},isEven:function(){return this%2==0},isOdd:function(){return this%
...
toPaddedString:function(g,e,j){j=Object.isUndefined(j)?"0":j.toString();e=this.toString(e||10);return j.times(g-e.length)+e},toBase:function(g){return this.toString(g).toUpperCase()},toChar:function(){return String.fromCharCode(this)},digits:function(){var g=this.toString().match(/e(.*)$/);return g?g[1].toNumber()>0?1+g[1].toNumber():0:this.toString().length},ordinalized:function(){switch(parseInt(this)){case 1:return"st";case 2:return"nd";case 3:return"rd";default:return"th"}}}}());
...
Class=function(){var b={Normal:1,Abstract:2},c=function(){return{addMethods:function(a){for(var d=this.superclass&&this.superclass.prototype,i=Object.keys(a),f=0,h=i.length;f<h;f++){var g=i[f],e=a[g];if(d&&Object.isFunction(e)&&e.argumentNames().first()=="$super"){var j=e;e=function(k){return function(){return d[k].apply(this,arguments)}}(g).wrap(j);e.valueOf=j.valueOf.bind(j);e.toString=j.toString.bind(j)}this.prototype[g]=e;if(this.__type__==Class.Abstract)this[g]=e}},addStatic:function(a){for(var d=
Object.keys(a),i=0,f=d.length;i<f;i++){var h=d[i];this[h]=a[h]}},addAttributes:function(a){Object.extendAttributes(this.prototype,a);this.__type__==Class.Abstract&&Object.extendAttributes(this,a)}}}();return{create:function(){var a=$A(arguments),d=Object.isFunction(a.first())?a.shift():null,i=function(){switch(this.__type__){case b.Abstract:throw Error("You cannot instantiate an abstract class.");default:if(Object.isFunction(this.initialize))return this.initialize.apply(this,arguments);break}return null};
i["__miniLOL.Class__"]=true;Object.extend(i,Class.Methods);i.superclass=d;i.subclasses=[];if(d){if(!d.__type__)d.__type__=b.Normal;if(!d.subclasses)d.subclasses=[];var f=Function.empty.clone();f.prototype=d.prototype;i.prototype=new f;d.subclasses.push(i)}i.__type__=i.prototype.__type__=a.first().type||Class.Normal;a.each(function(h){i.addMethods({initialize:h.initialize||h.constructor||Function.empty.clone()});i.addMethods(Object.without(h,["constructor","initialize","Methods","Static","Attributes"]));
i.addMethods(h.Methods||{});i.addStatic(h.Static||{});i.addAttributes(h.Attributes||{})});return i.prototype.constructor=i},Type:b,Methods:c}}();
miniLOL.utils=function(){return{exists:function(b){var c=false;new Ajax.Request(b,{method:"head",asynchronous:false,onSuccess:function(){c=true}});return c},get:function(b,c){var a;new Ajax.Request(b,Object.extend(c||{},{method:"get",asynchronous:false,onSuccess:function(d){a=d.responseText}}));return a},execute:function(b,c){var a,d;new Ajax.Request(b,Object.extend(c||{},{method:"get",asynchronous:false,evalJS:false,onSuccess:function(i){try{a=window.eval(i.responseText)}catch(f){d=f;d.fileName=
b;d.lineNumber-=5}},onFailure:function(i){d=Error("Failed to retrieve `#{file}` (#{status} - #{statusText}).".interpolate({file:b,status:i.status,statusText:i.statusText}));d.fileName=b;d.lineNumber=0}}));if(d)throw d;return a},include:function(b,c){var a=false;new Ajax.Request(b,Object.extend(c||{},{method:"get",asynchronous:false,evalJS:false,onSuccess:function(d){try{window.eval(d.responseText);a=true}catch(i){a=false}}}));return a},require:function(b,c){var a=false;new Ajax.Request(b,Object.extend(c||
{},{method:"get",asynchronous:false,evalJS:false,onSuccess:function(d){try{window.eval(d.responseText)}catch(i){a=i;a.fileName=b;a.lineNumber-=5}},onFailure:function(d){a=Error("Failed to retrieve `#{file}` (#{status} - #{statusText}).".interpolate({file:b,status:d.status,statusText:d.statusText}));a.fileName=b;a.lineNumber=0;a.http={status:d.status,text:d.statusText}}}));if(a)throw a;return true}}}();
...
"",path:!Object.isUndefined(g.path)?"path=#{0}; ".interpolate([g.path]):"",domain:!Object.isUndefined(g.domain)?"domain=#{0}; ".interpolate([g.domain]):"",secure:g.secure?"secure":""})}function a(){var f=[];window.document.cookie.split(/; /).each(function(h){h=h.split(/=/);f.push(h[0])});return f.uniq()}function d(f,h){h=b(h);var g=window.document.cookie.match(RegExp.escape(f.encodeURIComponent())+"=([^;]*)","g");if(g){var e=[];$A(g).each(function(j){j=j.match(/^.*?=(.*)$/)[1].decodeURIComponent();
e.push(h.raw?j:miniLOL.JSON.unserialize(j)||j)});if(e.length==1)e=e[0];return e}}function i(f,h){window.document.cookie=c(f,"",Object.extend(b(h),{expires:new Date(0)}))}return Object.extend(Enumerable,{_each:function(f){a().each(function(h){var g=d(h),e=[h,g];e.name=h;e.key=h;e.value=g;f(e)})},encode:c,keys:a,get:d,set:function(f,h,g){g=b(g);g.raw||(h=miniLOL.JSON.serialize(h)||h);window.document.cookie=c(f,h,g)},remove:i,unset:i,clear:function(){a().each(function(f){i(f)})}})}();
