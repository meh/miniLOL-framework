...
miniLOL.utils=function(){return{exists:function(b){var c=false;new Ajax.Request(b,{method:"head",asynchronous:false,evalJS:false,onSuccess:function(){c=true}});return c},get:function(b,c){var a;new Ajax.Request(b,Object.extend(c||{},{method:"get",asynchronous:false,evalJS:false,onSuccess:function(d){a=d.request.options.raw?d.responseText:d.responseXML||d.responseText}}));return a},execute:function(b,c){var a,d;new Ajax.Request(b,Object.extend(c||{},{method:"get",asynchronous:false,evalJS:false,onSuccess:function(j){try{a=
window.eval(j.responseText)}catch(f){d=f;d.fileName=b;d.lineNumber-=5}},onFailure:function(j){d=Error("Failed to retrieve `#{file}` (#{status} - #{statusText}).".interpolate({file:b,status:j.status,statusText:j.statusText}));d.fileName=b;d.lineNumber=0}}));if(d)throw d;return a},include:function(b,c){var a=false;new Ajax.Request(b,Object.extend(c||{},{method:"get",asynchronous:false,evalJS:false,onSuccess:function(d){try{window.eval(d.responseText);a=true}catch(j){a=false}}}));return a},require:function(b,
c){var a=false;new Ajax.Request(b,Object.extend(c||{},{method:"get",asynchronous:false,evalJS:false,onSuccess:function(d){try{window.eval(d.responseText)}catch(j){a=j;a.fileName=b;a.lineNumber-=5}},onFailure:function(d){a=Error("Failed to retrieve `#{file}` (#{status} - #{statusText}).".interpolate({file:b,status:d.status,statusText:d.statusText}));a.fileName=b;a.lineNumber=0;a.http={status:d.status,text:d.statusText}}}));if(a)throw a;return true}}}();
