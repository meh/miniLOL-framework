...
"")))})},Unsupported:function(){document.observe("dom:loaded",function(){miniLOL.History.reset(miniLOL.History.interval,miniLOL.History.Checkers.Default)})},InternetExplorer:function(){document.observe("dom:loaded",function(){miniLOL.History.IE={put:function(a){var b=miniLOL.History.IE.element.document;b.open();b.close();b.location.hash=encodeURIComponent(a.substring(1))},get:function(){return miniLOL.History.IE.element.document.location.hash.substring(1)},element:new Element("iframe",{name:"__miniLOL.History",
style:"display: none;",src:"javascript:false"})};$(document.body).insert({top:miniLOL.History.IE.element});miniLOL.History.IE.put(miniLOL.History.current);miniLOL.History.reset(miniLOL.History.interval,miniLOL.History.Checkers.InternetExplorer)})}},Checkers:{Default:function(){if(miniLOL.History.current!=window.location.hash)Event.fire(document,":url.change",Prototype.Browser.Mozilla?window.location.hash.replace(/^#/,""):decodeURIComponent(window.location.hash.replace(/^#/,"")))},InternetExplorer:function(){var a=
{iframe:miniLOL.History.IE.get(),actual:window.location.hash,current:miniLOL.History.current};if(a.actual!=a.iframe){if(a.actual!=a.current)a=miniLOL.History.current=a.iframe;else{a=miniLOL.History.current=a.actual;miniLOL.History.IE.put(a)}Event.fire(document,":url.change",a)}}}};miniLOL.History.initialize();
