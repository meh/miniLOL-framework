...
/^mailto:([\w.%+-]+@[\w.]+\.[A-Za-z]{2,4})$/.test(this)},parseURL:function(){var e;if(e=this.match(/^mailto:(([\w.%+-]+)@([\w.]+\.[A-Za-z]{2,4}))$/))return{protocol:"mailto",uri:e[1],user:e[2],host:e[3]};if(e=this.match(/^((\w+):\/\/(((.+?)(:(\d+))?)(\/.*)?))$/))return{full:e[1],protocol:e[2],uri:e[3],host:e[4],hostname:e[5],port:e[7],path:e[8]};return false},blank:function(){return this==0},getHashFragment:function(){var e=this.match(/(#.*)$/);return e?e[1]:""},encodeURI:function(){return a(this)},
