...
Object.extend(String,function(){return{fromAttributes:function(b){for(var c="",a=0;a<b.length;a++)c+='#{name}="#{value}" '.interpolate({name:b.item(a).nodeName,value:b.item(a).nodeValue});return c},fromXML:function(b){return!Object.isXML(b)?!1:(new XMLSerializer).serializeToString(b)}}}());
Object.extend(String.prototype,function(){function b(a){Object.isRegExp(a)||(a=/&/);var b={},c=this.match(/[?#](.*?)([#?]|$)/);if(!c)return b;a=c[1].split(a);for(c=0;c<a.length;c++){var d=a[c].split(/=/),e=d[0].decodeURIComponent();(d=d[1])?Object.isUndefined(b[e])?b[e]=d.decodeURIComponent():Object.isArray(b[e])?b[e].push(d):b[e]=[b[e],d]:b[e]=!0}return b}var c=window.encodeURI,a=window.decodeURI,d=window.encodeURIComponent,e=window.decodeURIComponent;return{toQueryParams:b,parseQuery:b,toXML:function(){return(new DOMParser).parseFromString(this,
"text/xml")},isURL:function(){return/^(\w+):(\/\/.+?(:\d)?)(\/)?/.test(this)||/^mailto:([\w.%+-]+@[\w.]+\.[A-Za-z]{2,4})$/.test(this)},parseURL:function(){var a;return(a=this.match(/^mailto:(([\w.%+-]+)@([\w.]+\.[A-Za-z]{2,4}))$/))?{protocol:"mailto",uri:a[1],user:a[2],host:a[3]}:(a=this.match(/^((\w+):\/\/(((.+?)(:(\d+))?)(\/.*)?))$/))?{full:a[1],protocol:a[2],uri:a[3],host:a[4],hostname:a[5],port:a[7],path:a[8]}:!1},blank:function(){return this==0},getHashFragment:function(){var a=this.match(/(#.*)$/);
...
!1;new Ajax.Request(b,Object.extend(c||{},{method:"get",asynchronous:!1,evalJS:!1,onSuccess:function(a){try{window.eval(a.responseText),d=!0}catch(b){d=!1}}}));return d},require:function(b,c){c=c||{};if(b.startsWith("http")){var a=new Element("script",{type:"text/javascript",src:b,id:c.id});$(document.head).insert(a);return!0}var d=!1;new Ajax.Request(b,Object.extend(c||{},{method:"get",asynchronous:!1,evalJS:!1,onSuccess:function(a){try{window.eval(a.responseText)}catch(c){d=c,d.fileName=b,d.lineNumber-=
5}},onFailure:function(a){d=Error("Failed to retrieve `#{file}` (#{status} - #{statusText}).".interpolate({file:b,status:a.status,statusText:a.statusText}));d.fileName=b;d.lineNumber=0;d.http={status:a.status,text:a.statusText}}}));if(d)throw d;return!0}}}();
