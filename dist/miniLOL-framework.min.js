...
Error("Failed to retrieve `#{file}` (#{status} - #{statusText}).".interpolate({file:a,status:c.status,statusText:c.statusText}));b.fileName=a;b.lineNumber=0;b.http={status:c.status,text:c.statusText}}});if(b)throw b;return true}};
