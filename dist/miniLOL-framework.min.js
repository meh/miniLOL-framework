...
/* miniLOL is released under AGPLv3. Copyleft meh. [http://meh.doesntexist.org | meh.ffff@gmail.com] */
/* miniLOL is released under AGPLv3. Copyleft meh. [http://meh.doesntexist.org | meh.ffff@gmail.com] */
miniLOL.utils={XML:{getElementById:function(a){var b;$A(this.getElementsByTagName("*")).each(function(c){if(c.getAttribute("id")==a){b=c;throw $break;}});return b},xpath:function(a){var b=[];if(Prototype.Browser.IE){a=this.real.selectNodes(a);for(var c=0;c<a.length;c++)b.push(a.item(c))}else{a=(this.ownerDocument||this).evaluate(a,this,null,XPathResult.ORDERED_NODE_SNAPSHOT_TYPE,null);for(c=0;c<a.snapshotLength;c++)b.push(a.snapshotItem(c))}return b},select:function(a){return Prototype.Selector.select(a,
this)},fix:function(a){if(a){if(Prototype.Browser.IE){a={real:a};a.documentElement=a.real.documentElement;a.getElementsByTagName=function(b){return this.real.getElementsByTagName(b)};a.getElementById=function(b){return miniLOL.utils.XML.getElementById.call(this.real,b)};a.real.setProperty("SelectionLanguage","XPath")}else if(!Prototype.Browser.Good)a.getElementById=miniLOL.utils.XML.getElementById;a.xpath=miniLOL.utils.XML.xpath;a.select=miniLOL.utils.XML.select;return a}},check:function(a,b){var c=
false;a||(c="There is a syntax error.");if(a.documentElement.nodeName=="parsererror")c=a.documentElement.textContent;if(b&&c){miniLOL.error("Error while parsing #{path}\n\n#{error}".interpolate({path:b,error:c}),true);return c}return c},getFirstText:function(a){var b="";(Object.isArray(a)?a:$A(a)).each(function(c){switch(c.nodeType){case Node.ELEMENT_NODE:throw $break;case Node.CDATA_SECTION_NODE:case Node.TEXT_NODE:if(!c.nodeValue.blank()){b=c.nodeValue.strip();throw $break;}}});return b}},exists:function(a){var b=
false;new Ajax.Request(a,{method:"head",asynchronous:false,onSuccess:function(){b=true}});return b},includeCSS:function(a){var b;if(b=miniLOL.theme.style.list[a])return b;else if(b=$$("link").find(function(c){return c.getAttribute("href")==a}))return miniLOL.theme.style.list[a]=b;else if(b=miniLOL.utils.exists(a)){b=new Element("link",{rel:"stylesheet",href:a,type:"text/css"});$$("head")[0].insert(b);Event.fire(document,":css.included",b);return b}else return false},css:function(a,b){var c=(new Element("style",
...
status:c.status,statusText:c.statusText}));b.fileName=a;b.lineNumber=0;b.http={status:c.status,text:c.statusText}}});if(b)throw b;return true}};if(navigator.userAgent.match(/Chrome/))Prototype.Browser.Chrome=true;if(navigator.userAgent.match(/Safari/)&&!Prototype.Browser.Chrome)Prototype.Browser.Safari=true;if(Prototype.Browser.Gecko||Prototype.Browser.Opera)Prototype.Browser.Good=true;else Prototype.Browser.Bad=true;
...
"",c;for(c in a)b+="#{name}=#{value}&".interpolate({name:c,value:a[c]});return b.substr(0,b.length-1)}});if(!Object.isFunction(Object.defineProperty))Object.defineProperty=function(a,b,c){Object.isFunction(c.get)&&Object.isFunction(a.__defineGetter__)&&a.__defineGetter__(b,c.get);Object.isFunction(c.set)&&Object.isFunction(a.__defineSetter__)&&a.__defineSetter__(b,c.set)};
